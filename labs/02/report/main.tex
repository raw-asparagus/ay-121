...
Diatribe on the different components of the instrumentation and observables,
from the 21-cm hydrogen line emmissions from celestial objects, to the radio
dish, to signal propagation through transmission lines, to signal capture.
...
\subsubsection{Efficiency of the big horn antenna}

\subsection{Signal propagation through transmission lines}

\subsubsection{The transmission cable}

\subsubsection{The terminals}

There are different types of connectors, e.g. F-type connectors.
...
\subsection{The Software Defined Radio}
...
\subsection{Fourier Analysis interpretation of Gaussianity, the Central LImit Theorem, and Experimental Noise}
