...
\caption{Jinc fit and Bessel extrema at a representative channel. The scatter shows the normalised $|V|$ versus hour angle; the green curve is the best-fit jinc model with $R$ free. Triangles mark identified maxima (orange) and minima (red). The fitted diameter annotation appears in the upper right.}
\label{fig:jinc_fit}
\end{figure*}
