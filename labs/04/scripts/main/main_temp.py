#!/usr/bin/env python3
"""Lab 4 - Leuschner Sky Survey -- Galactic Plane (temp: l>=20).

Temporary script covering l=[20, 250].  Cells below l=20 are too far
south to be accessible until later; use main.py (l>=−10) when those
longitudes are near transit.
...
# Grid bounds -- start from l=20 (currently accessible)
L_CENTER     = 120.0
L_MIN, L_MAX = 20.0, 250.0
B_MIN, B_MAX = -4, 4
B_STEP       = 2
...
def main():
    print('Leuschner Sky Survey -- Galactic Plane (temp: l>=20)')
    print('=' * 60)
